...
class WikiScreen extends Component {
  ...
  async triggerRefresh() {
    ...
    this.setState({opinions: response.data.content})
  ...
  async componentWillMount() {
    ...
    const response = await axios.post(url, data, params)
    const wikiEntries = response.data.content
    console.log(wikiEntries, 'wikiEntries')
    this.setState({item: item, opinions: wikiEntries})
  }
